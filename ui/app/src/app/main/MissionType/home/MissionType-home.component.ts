...
@Component({
  selector: 'MissionType-home',
  templateUrl: './MissionType-home.component.html',
  styleUrls: ['./MissionType-home.component.scss']
})
export class MissionTypeHomeComponent implements AfterViewInit {
