...
@Component({
  selector: 'SpaceSector-home',
  templateUrl: './SpaceSector-home.component.html',
  styleUrls: ['./SpaceSector-home.component.scss']
})
export class SpaceSectorHomeComponent implements AfterViewInit {
