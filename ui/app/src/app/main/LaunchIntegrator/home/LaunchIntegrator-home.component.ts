...
@Component({
  selector: 'LaunchIntegrator-home',
  templateUrl: './LaunchIntegrator-home.component.html',
  styleUrls: ['./LaunchIntegrator-home.component.scss']
})
export class LaunchIntegratorHomeComponent implements AfterViewInit {
