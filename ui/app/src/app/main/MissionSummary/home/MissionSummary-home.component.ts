...
@Component({
  selector: 'MissionSummary-home',
  templateUrl: './MissionSummary-home.component.html',
  styleUrls: ['./MissionSummary-home.component.scss']
})
export class MissionSummaryHomeComponent implements AfterViewInit {
