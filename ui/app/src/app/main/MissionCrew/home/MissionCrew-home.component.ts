...
@Component({
  selector: 'MissionCrew-home',
  templateUrl: './MissionCrew-home.component.html',
  styleUrls: ['./MissionCrew-home.component.scss']
})
export class MissionCrewHomeComponent implements AfterViewInit {
