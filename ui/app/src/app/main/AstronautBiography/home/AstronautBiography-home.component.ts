...
@Component({
  selector: 'AstronautBiography-home',
  templateUrl: './AstronautBiography-home.component.html',
  styleUrls: ['./AstronautBiography-home.component.scss']
})
export class AstronautBiographyHomeComponent implements AfterViewInit {
