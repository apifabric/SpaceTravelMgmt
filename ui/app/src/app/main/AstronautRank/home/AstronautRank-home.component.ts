...
@Component({
  selector: 'AstronautRank-home',
  templateUrl: './AstronautRank-home.component.html',
  styleUrls: ['./AstronautRank-home.component.scss']
})
export class AstronautRankHomeComponent implements AfterViewInit {
