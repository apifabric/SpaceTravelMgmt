...
@Component({
  selector: 'SpacecraftComponent-home',
  templateUrl: './SpacecraftComponent-home.component.html',
  styleUrls: ['./SpacecraftComponent-home.component.scss']
})
export class SpacecraftComponentHomeComponent implements AfterViewInit {
