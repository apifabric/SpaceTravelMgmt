...
resourcename="spacetravelmgmt"  # lower case, only
resourcegroup="spacetravelmgmt_rg"
...
# git clone https://github.com/apilogicserver/spacetravelmgmt.git
# cd spacetravelmgmt
...
az group create --name spacetravelmgmt_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group spacetravelmgmt_rg --sku S1 --is-linux
az container create --resource-group spacetravelmgmt_rg --name spacetravelmgmt --image apilogicserver/spacetravelmgmt:latest --dns-name-label spacetravelmgmt --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//spacetravelmgmt.westus.azurecontainer.io:5656'
