...
def declare_logic():
    ...
    # Ensures the correct number of astronauts are assigned for each mission
    Rule.count(derive=MissionSummary.total_astronauts, as_count_of=MissionCrew)

    # Calculates the total mission duration based on planned missions
    Rule.sum(derive=MissionSummary.total_duration, as_sum_of=Mission.duration_days)
